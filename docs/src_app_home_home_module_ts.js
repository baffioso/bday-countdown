...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns */ 2779);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns */ 7860);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! date-fns */ 371);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! date-fns */ 9805);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! date-fns */ 8210);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! date-fns */ 2258);
...
let StoreService = class StoreService {
    constructor() {
        this._dateOfBirth$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__.BehaviorSubject(null);
        this.dateOfBirth$ = this._dateOfBirth$.asObservable();
        this._timeUnit$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__.BehaviorSubject(src_models_time_unit__WEBPACK_IMPORTED_MODULE_0__.TimeUnit.days);
        this.timeUnit$ = this._timeUnit$.asObservable();
        this.nextBday$ = this.dateOfBirth$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(this.nextBday));
        this.timeToBday$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.combineLatest)([
            (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.interval)(1000),
            this.nextBday$,
            this.timeUnit$
        ]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)(([, time, unit]) => !!time || !!unit), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(([, time, unit]) => this.timeToBday(time, unit)));
    }
    setBday(bday) {
    ...
    nextBday(bday) {
        ...
        return currentYearBday.getTime() - now.getTime() > 0 ?
            currentYearBday :
            (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(currentYearBday, 1);
    }
    timeToBday(nextBday, timeUnit) {
        ...
        switch (timeUnit) {
            case src_models_time_unit__WEBPACK_IMPORTED_MODULE_0__.TimeUnit.seconds:
                timeToBday = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(nextBday, now);
                break;
            ...
            case src_models_time_unit__WEBPACK_IMPORTED_MODULE_0__.TimeUnit.days:
                timeToBday = (0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(nextBday, now) + 1;
                break;
            case src_models_time_unit__WEBPACK_IMPORTED_MODULE_0__.TimeUnit.months:
                timeToBday = (0,date_fns__WEBPACK_IMPORTED_MODULE_11__["default"])(nextBday, now);
                break;
            default:
                break;
        }
...
StoreService = (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([
...
module.exports = ".time-unit-selector {\n  width: 100%;\n  position: fixed;\n  bottom: 0;\n  overflow-x: auto;\n  z-index: 100;\n  background-color: #ffcd00;\n  height: 50px;\n  display: flex;\n  align-items: center;\n}\n\n.count-down-container {\n  height: 100%;\n  width: 100%;\n  background: url(\"/assets/images/pokemon.jpg\") no-repeat center center fixed;\n  background-size: cover;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n}\n\n.count-down-container .counter {\n  width: 100%;\n  max-width: 600px;\n  height: 235px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  background-color: rgba(0, 0, 0, 0.8);\n  padding: 10px;\n  border-radius: 5px;\n}\n\n.count-down-container .counter h1 {\n  text-align: center;\n  color: var(--ion-color-danger);\n  font-size: 24vw;\n}\n\n.count-down-container .counter p {\n  color: var(--ion-color-primary);\n  text-align: center;\n}\n\n.date-picker-container {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-direction: column;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
